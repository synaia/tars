...
const Navigations = () => {
  ...
  return (
    <>
      ...
      <StyledButton color="inherit" variant="text" component={NavLink} to="/services">
        Services
      </StyledButton>
      <StyledButton color="inherit" variant="text" component={NavLink} to="/contact">
        Contact
      </StyledButton>
      <Button color="primary" target="_blank" variant="contained" className='black' component={NavLink} to="/auth/login">
        Login with Facebook
      </Button>
    </>
  );
