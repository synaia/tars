...
import Service2 from 'src/components/apps/services/Service2';
...
const Servicespage2 = () => {
  return (
    <PageContainer title="AI Automations | Synaia" description="Synaia services page">
      <LpHeader />
      <Container maxWidth="lg">
        <Grid container justifyContent="space-between" spacing={3}>
          <Grid item xs={12} sm={12} lg={12}>
            <Breadcrumb title="AI Automations" items={BCrumb}>
              <Box>
