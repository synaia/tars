...
const Servicespage = () => {
  return (
    <PageContainer title="Services | Synaia" description="Synaia services page">
      <LpHeader />
      <Container maxWidth="lg">
        <Grid container justifyContent="space-between" spacing={3}>
          <Grid item xs={12} sm={12} lg={12}>
            <Breadcrumb title="Services" subtitle="At Synaia, we prioritize trust and quality in every service we offer. From expert web development to strategic digital marketing, our dedicated team ensures top-notch solutions tailored to your needs. Experience unparalleled service and results you can rely on with Synaia.">
              <Box>
