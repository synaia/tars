...
import Service4 from 'src/components/apps/services/Service4';
...
const Servicespage4 = () => {
  return (
    <PageContainer title="WhatsApp Workflows | Synaia" description="Synaia services page">
      <LpHeader />
      <Container maxWidth="lg">
        <Grid container justifyContent="space-between" spacing={3}>
          <Grid item xs={12} sm={12} lg={12}>
            <Breadcrumb title="WhatsApp Workflows" items={BCrumb}>
              <Box>
