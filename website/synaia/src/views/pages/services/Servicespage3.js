...
import Service3 from 'src/components/apps/services/Service3';
...
const Servicespage3 = () => {
  return (
    <PageContainer title="Data Science | Synaia" description="Synaia services page">
      <LpHeader />
      <Container maxWidth="lg">
        <Grid container justifyContent="space-between" spacing={3}>
          <Grid item xs={12} sm={12} lg={12}>
            <Breadcrumb title="Data Science" items={BCrumb}>
              <Box>
