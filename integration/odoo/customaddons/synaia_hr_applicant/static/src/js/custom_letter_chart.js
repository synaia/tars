...
export class LetterChart extends Component {
    setup() {
        this.chart = null;
    ...
    renderChart() {
        const score = this.props.record.data[this.props.score] || 0; // parseFloat(this.props.score);
        const progressBarValue = score; //this.props.record.data[this.props.name];
...
registry.category("fields").add("letter_chart", doughnutProgressField);
